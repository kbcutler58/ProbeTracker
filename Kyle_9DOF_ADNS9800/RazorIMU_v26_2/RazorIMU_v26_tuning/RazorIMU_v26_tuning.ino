...
#define accel_z_min ((float) -265)
#define accel_x_max ((float) 244)
#define accel_y_max ((float) 262)
#define accel_z_max ((float) 239)
//
...
//
#define gyro_offset_x ((float) -20.23)
#define gyro_offset_y ((float) 68.64)
#define gyro_offset_z ((float) -34.07)

const float magnet_ellipsoid_center[3] = {37.018, 41.1269, 68.8389};
const float magnet_ellipsoid_transform[3][3] = {{0.95197, 0.0296944, 0.0222126}, {0.0296944, 0.934246, -0.0126819}, {0.0222126, -0.0126819, 0.989704}};
